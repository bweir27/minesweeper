...
var config = {
  ...
  baseUrl: `http://brianweirdev-minesweeper-nodejs:${process.env.PORT || '9001'}`,
  ...
  restartBrowserBetweenTests: true,
    ...
    multiCapabilities: [{
        browserName: 'chrome',
        seleniumAddress: 'http://brianweirdev-minesweeper-selenium-chrome:4444/wd/hub',
        chromeOptions: {
        args: [
            '--disable-gpu',
        ]},
        ...
        browserName: 'firefox',
        seleniumAddress: 'http://brianweirdev-minesweeper-selenium-firefox:4444/wd/hub'
    }],
